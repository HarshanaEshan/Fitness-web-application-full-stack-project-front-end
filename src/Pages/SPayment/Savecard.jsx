    ...
    return (
        <div>
            ...
            <form onSubmit={handleSubmit}>
                    ...
                    <input type="text" name="exDate" value={formData.exDate} onChange={handleChange} required/>
                
                    <label>CVC:</label>
                    <input type="text" name="cvc" value={formData.cvc} onChange={handleChange} required/>
